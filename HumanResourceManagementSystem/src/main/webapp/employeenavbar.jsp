			...
			<header>
				<nav id="nav" class="navbar navbar-expand-md navbar-dark">
					...
					<ul class="navbar-nav">
						...
						<li><a href="<%=request.getContextPath()%>/leaverequestlist" class="nav-link">Leave History</a>
						</li>
						<li> <a href="applyLeave.jsp" class="nav-link">Apply For Leave</a> </li>
						<li> <a href="updateProjectcompletion.jsp" class="nav-link">Update Working Project Status</a>
						</li>
