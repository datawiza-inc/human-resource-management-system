<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
  ...
  <body>
    ...
    <form id="f2" action="addUpdateEmployeedept" method="post">
      <input type="hidden" value=<%=request.getParameter("username") %> name="email" placeholder="Enter Employee
      username" maxlength="30">
      Enter Department Id: <input type="number" name="deptId" placeholder="Enter the Department Id" maxlength="3">

      <input type="submit" style="background-color: rgb(13, 0, 96); color: azure;"
        value="Add OR Update Employee Department">
